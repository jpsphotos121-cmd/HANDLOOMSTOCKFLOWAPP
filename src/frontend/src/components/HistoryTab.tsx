...
function HistoryTab({
  ...
  const handleDelete = (id: number) => {
    setConfirmDialog({
      ...
      onConfirm: () => {
        // Reverse inventory quantities for inward-type entries
        ...
        if (
          ...
          for (const bi of tx.baleItemsList || []) {
            ...
            // Reverse each godown qty
            for (const [gdown, qty] of Object.entries(bi.godownQuants || {})) {
              if (qty) {
                updateStock(
                  realSku,
                  { category: bi.category, itemName: bi.itemName },
        ...
        // Remove matching inwardSaved entry
